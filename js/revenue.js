...
var T='qr-generator:QR Code Generator:m,password-generator:Password Generator:u,json-formatter:JSON Formatter:d,color-palette:Color Palette Generator:g,gradient-generator:CSS Gradient Generator:g,text-analyzer:Text Analyzer:t,base64:Base64 Encoder/Decoder:d,regex-tester:Regex Tester:d,markdown-preview:Markdown Preview:t,image-compressor:Image Compressor:m,unit-converter:Unit Converter:c,lorem-generator:Lorem Ipsum Generator:t,css-formatter:CSS Beautifier:d,hash-generator:Hash Generator:d,timestamp-converter:Timestamp Converter:c,diff-checker:Diff Checker:d,emoji-picker:Emoji Picker:t,meta-tag-generator:Meta Tag Generator:d,favicon-generator:Favicon Generator:m,box-shadow-generator:Box Shadow Generator:g,pomodoro-timer:Pomodoro Timer:u,markdown-table:Markdown Table Generator:t,color-converter:Color Converter:g,placeholder-image:Placeholder Image:m,svg-optimizer:SVG Optimizer:m,aspect-ratio-calculator:Aspect Ratio Calculator:g,crontab-generator:Crontab Generator:d,json-to-csv:JSON to CSV:c,html-to-markdown:HTML to Markdown:c,chmod-calculator:chmod Calculator:d,ip-info:IP Address Info:u,noise-generator:Noise Generator:u,url-encoder:URL Encoder/Decoder:d,text-diff-merger:Text Diff & Merger:t,yaml-json:YAML/JSON Converter:c,pixel-ruler:Pixel Ruler:g,color-picker:Color Picker:g,json-viewer:JSON Viewer:d,character-counter:Character Counter:t,random-generator:Random Generator:u,html-formatter:HTML Formatter:d,javascript-formatter:JavaScript Formatter:d,yaml-formatter:YAML Formatter:d,csv-formatter:CSV Formatter:c,morse-code:Morse Code Translator:c,countdown-timer:Countdown Timer:u,notepad:Online Notepad:t,keyboard-tester:Keyboard Tester:u,image-resizer:Image Resizer:m,text-to-speech:Text to Speech:u,json-editor:JSON Editor:d,stopwatch:Stopwatch:u,typing-speed-test:Typing Speed Test:u,age-calculator:Age Calculator:u,invoice-generator:Invoice Generator:u,code-screenshot:Code Screenshot:d,color-name-finder:Color Name Finder:g,whiteboard:Online Whiteboard:g,screen-resolution:Screen Resolution:u,text-repeater:Text Repeater:t,api-request-builder:API Request Builder:d,barcode-generator:Barcode Generator:m,binary-converter:Binary Converter:c,bmi-calculator:BMI Calculator:u,border-radius-generator:Border Radius Generator:g,color-blindness-simulator:Color Blindness Simulator:g,color-contrast-checker:Color Contrast Checker:g,color-palette-from-image:Color Palette from Image:g,color-shade-generator:Color Shade Generator:g,cron-expression-builder:Cron Expression Builder:d,css-animation-generator:CSS Animation Generator:g,css-clip-path:CSS Clip Path Generator:g,css-filter-generator:CSS Filter Generator:g,css-grid-generator:CSS Grid Generator:g,css-minifier:CSS Minifier:d,css-specificity-calculator:CSS Specificity Calculator:g,css-text-shadow-generator:Text Shadow Generator:g,css-transform-generator:CSS Transform Generator:g,css-unit-converter:CSS Unit Converter:c,css-variable-generator:CSS Variable Generator:g,csv-editor:CSV Editor:c,csv-to-json:CSV to JSON:c,curl-to-code:cURL to Code:d,data-url-generator:Data URL Generator:d,date-calculator:Date Calculator:u,dns-lookup:DNS Lookup:u,docker-compose-generator:Docker Compose Generator:d,editorconfig-generator:EditorConfig Generator:d,email-signature-generator:Email Signature Generator:u,encode-decode-multi:Multi Encoder Decoder:c,eslint-config-generator:ESLint Config Generator:d,flexbox-playground:Flexbox Playground:g,font-pair-generator:Font Pair Generator:g,git-command-builder:Git Command Builder:d,gitignore-generator:Gitignore Generator:d,glassmorphism-generator:Glassmorphism Generator:g,gradient-text-generator:Gradient Text Generator:g,htaccess-generator:htaccess Generator:d,html-email-builder:HTML Email Builder:d,html-entity-encoder:HTML Entity Encoder:d,html-live-preview:HTML Live Preview:d,html-minifier:HTML Minifier:d,html-table-generator:HTML Table Generator:d,http-status-codes:HTTP Status Codes:d,ical-generator:iCal Generator:u,image-to-base64:Image to Base64:m,javascript-minifier:JavaScript Minifier:d,json-diff:JSON Diff:d,json-path-finder:JSON Path Finder:d,json-resume-builder:JSON Resume Builder:u,json-schema-generator:JSON Schema Generator:d,json-to-typescript:JSON to TypeScript:d,json-to-xml:JSON to XML:c,jwt-decoder:JWT Decoder:d,jwt-generator:JWT Generator:d,loan-calculator:Loan Calculator:u,markdown-to-html:Markdown to HTML:c,neumorphism-generator:Neumorphism Generator:g,nginx-config-generator:Nginx Config Generator:d,og-image-preview:OG Image Preview:m,open-graph-generator:Open Graph Generator:d,package-json-generator:Package.json Generator:d,page-title-tester:Page Title Tester:d,percentage-calculator:Percentage Calculator:u,privacy-policy-generator:Privacy Policy Generator:u,readme-generator:README Generator:d,regex-builder:Regex Builder:d,responsive-tester:Responsive Tester:g,robots-txt-generator:Robots.txt Generator:d,schema-markup-generator:Schema Markup Generator:d,sitemap-generator:Sitemap Generator:d,slug-generator:Slug Generator:t,sql-formatter:SQL Formatter:d,subnet-calculator:Subnet Calculator:u,svg-path-editor:SVG Path Editor:g,svg-to-css:SVG to CSS:g,tailwind-converter:Tailwind Converter:g,text-case-converter:Text Case Converter:t,text-to-binary:Text to Binary:c,tos-generator:Terms of Service Generator:u,tsconfig-generator:TSConfig Generator:d,twitter-card-preview:Twitter Card Preview:m,typescript-playground:TypeScript Playground:d,typography-scale:Typography Scale:g,uuid-generator:UUID Generator:d,vcard-generator:vCard Generator:u,word-counter:Word Counter:t,xml-formatter:XML Formatter:d,xml-to-json:XML to JSON:c'.split(',').map(function(s){var p=s.split(':');return{s:p[0],n:p[1],c:p[2]};});
...
var A='10-developer-tools-2026:10 Developer Tools You Need in 2026:d,api-testing-guide:The Complete API Testing Guide:d,api-design-best-practices:API Design Best Practices:d,git-workflow-guide:Git Workflow Guide for Teams:d,free-developer-tools-2026:Free Developer Tools in 2026:dc,developer-productivity-tools-2026:Developer Productivity Tools 2026:du,javascript-performance-optimization:JavaScript Performance Optimization:d,css-tricks-every-developer-should-know:CSS Tricks Every Developer Should Know:gd,css-animations-complete-guide:CSS Animations Complete Guide:g,css-layout-masterclass:CSS Layout Masterclass:g,responsive-design-guide-2026:Responsive Design Guide 2026:gm,ai-content-brand-voice-framework:AI Content & Brand Voice Framework:t,build-landing-page-one-hour:Build a Landing Page in One Hour:tgm,automation-saves-20-hours-week:How Automation Saves 20 Hours/Week:ua,automate-business-workflows:Automate Your Business Workflows:ua,best-ai-tools-small-business-2026:Best AI Tools for Small Business:ua,ai-solopreneur-playbook:The AI Solopreneur Playbook:ua,web-security-checklist:Web Security Checklist 2026:du,create-privacy-policy-guide:Create a Privacy Policy Guide:du,why-small-business-needs-website-2026:Why Your Business Needs a Website:a,5-costly-website-mistakes:5 Costly Website Mistakes to Avoid:a,website-templates-vs-custom-build:Templates vs Custom Build:gm,data-format-conversion-guide:Convert Between JSON CSV XML and YAML:dc,regex-patterns-every-developer-needs:20 Regex Patterns Every Developer Needs:d,cron-syntax-guide:Cron Job Syntax Demystified:du,jwt-tokens-explained:JWT Tokens Explained:d,image-optimization-web-guide:How to Optimize Images for the Web:gm,markdown-complete-guide:Markdown Syntax Complete Guide:dt,color-accessibility-wcag-guide:Web Accessibility Color Guide:gd,meta-tags-open-graph-guide:Meta Tags Open Graph and Twitter Cards Guide:d,encoding-hashing-explained:Base64 URL Encoding and Hashing Explained:du,docker-compose-tutorial:Docker Compose Tutorial:d,ai-agents-replacing-freelancers:How AI Agents Are Replacing Freelancers:ua,ai-chatbots-vs-human-support:AI Chatbots vs Human Support:ua,diy-automation-fails:Why DIY Automations Break:ua,how-to-automate-business-with-n8n:How to Automate with n8n:ua,real-cost-building-own-tools:The Real Cost of Building Your Own Tools:du'.split(',').map(function(s){var p=s.split(':');return{s:p[0],t:p[1],c:p[2]};});
