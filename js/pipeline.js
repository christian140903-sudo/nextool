...
['curl-to-code','cURL to Code','#curlInput','#codeOutput','d'],
['encode-decode-multi','Multi Encoder/Decoder','#mainInput','#outputBox','c'],
['data-url-generator','Data URL Generator','#textInput','#dataUrlOut','c'],
['html-table-generator','HTML Table Generator','#csvInput','#htmlOutput','c'],
['json-schema-generator','JSON Schema Generator','#inputJSON','#outputSchema','d'],
['json-to-typescript','JSON to TypeScript','#jsonInput','#tsOutput','c'],
['json-to-xml','JSON to XML','#inputArea','#outputArea','c'],
['markdown-table','Markdown Table','#csvInput','#mdOutput','t'],
['markdown-to-html','Markdown to HTML','#mdInput',null,'c'],
['slug-generator','Slug Generator','#slugInput','#slugOutput','t'],
['tailwind-converter','Tailwind Converter','#cssInput','#outputArea','c'],
['text-diff-merger','Text Diff Merger','#conv-input','#conv-output','t'],
['xml-to-json','XML to JSON','#xmlInput','#jsonOutput','c'],
['xml-formatter','XML Formatter','#inputArea','#outputArea','d'],
['html-minifier','HTML Minifier','#inputCode','#outputCode','d'],
['javascript-minifier','JS Minifier','#inputCode','#outputCode','d'],
['svg-optimizer','SVG Optimizer','#inputSvg','#outputSvg','d'],
['json-diff','JSON Diff','#leftInput',null,'d'],
['regex-builder','Regex Builder','#patternInput',null,'d'],
['html-live-preview','HTML Live Preview','#htmlEditor',null,'d'],
['dns-lookup','DNS Lookup','#domainInput',null,'u'],
['ip-info','IP Address Info','#ip-input',null,'u'],
['gitignore-generator','.gitignore Generator',null,'#output','d'],
['robots-txt-generator','Robots.txt Generator',null,'#output','d'],
['docker-compose-generator','Docker Compose',null,'#output','d'],
['editorconfig-generator','EditorConfig',null,'#output','d'],
['readme-generator','README Generator',null,'#output','d'],
['package-json-generator','package.json',null,'#output','d'],
['tsconfig-generator','tsconfig.json',null,'#output','d'],
['nginx-config-generator','Nginx Config',null,'#output','d'],
['eslint-config-generator','ESLint Config',null,'#output','d'],
['schema-markup-generator','Schema Markup',null,'#output','d'],
['sitemap-generator','Sitemap Generator',null,'#xmlOutput','d'],
['privacy-policy-generator','Privacy Policy',null,'#outputPreview','u'],
['tos-generator','Terms of Service',null,'#outPreview','u'],
['unit-converter','Unit Converter','#input-val','#output-val','u'],
['css-specificity-calculator','CSS Specificity','#singleInput',null,'d'],
['age-calculator','Age Calculator',null,null,'u'],
['api-request-builder','API Request Builder','#urlInput',null,'d'],
['aspect-ratio-calculator','Aspect Ratio Calculator',null,'#cssOutput','u'],
['barcode-generator','Barcode Generator','#barcodeData',null,'u'],
['bmi-calculator','BMI Calculator',null,null,'u'],
['border-radius-generator','Border Radius Generator',null,'#cssBar','d'],
['box-shadow-generator','Box Shadow Generator',null,'#codeOutput','d'],
['chmod-calculator','chmod Calculator','#octal-input','#out-cmd','d'],
['color-blindness-simulator','Color Blindness Simulator','#colorHex',null,'d'],
['color-contrast-checker','Color Contrast Checker','#fgHex',null,'d'],
['color-name-finder','Color Name Finder','#hexInput',null,'d'],
['color-palette-from-image','Color Palette from Image',null,null,'d'],
['color-palette','Color Palette Generator',null,null,'d'],
['color-picker','Color Picker','#hexInput','#cssOutput','d'],
['color-shade-generator','Color Shade Generator','#baseHex','#exportCode','d'],
['countdown-timer','Countdown Timer',null,null,'u'],
['cron-expression-builder','Cron Expression Builder','#cronInput','#cronInput','d'],
['crontab-generator','Crontab Generator','#validateInput','#cronValue','d'],
['css-animation-generator','CSS Animation Generator',null,'#codeOutput','d'],
['css-clip-path','CSS Clip Path Generator',null,'#codeOutput','d'],
['css-filter-generator','CSS Filter Generator',null,'#codeOutput','d'],
['css-grid-generator','CSS Grid Generator',null,'#codeOutput','d'],
['css-text-shadow-generator','CSS Text Shadow','#textInput','#codeOutput','d'],
['css-transform-generator','CSS Transform Generator',null,'#codeOutput','d'],
['css-variable-generator','CSS Variable Generator',null,'#output','d'],
['csv-editor','CSV Editor','#pasteArea',null,'c'],
['date-calculator','Date Calculator',null,null,'u'],
['email-signature-generator','Email Signature Generator','#fullName','#codeBlock','u'],
['emoji-picker','Emoji Picker','#emojiSearch',null,'t'],
['favicon-generator','Favicon Generator',null,'#tagsOutput','d'],
['flexbox-playground','Flexbox Playground',null,'#codeOutput','d'],
['font-pair-generator','Font Pair Generator',null,'#codeBlock','d'],
['git-command-builder','Git Command Builder',null,'#cmdPreview','d'],
['glassmorphism-generator','Glassmorphism Generator',null,'#codeOutput','d'],
['gradient-generator','Gradient Generator',null,'#cssCode','d'],
['gradient-text-generator','Gradient Text Generator','#textInput','#codeOutput','d'],
['htaccess-generator','.htaccess Generator',null,'#codeOutput','d'],
['html-email-builder','HTML Email Builder',null,'#output','d'],
['http-status-codes','HTTP Status Codes','#searchInput',null,'d'],
['ical-generator','iCal Generator',null,'#icsPreview','u'],
['image-compressor','Image Compressor',null,null,'u'],
['image-resizer','Image Resizer',null,null,'u'],
['image-to-base64','Image to Base64',null,'#outputText','c'],
['json-resume-builder','JSON Resume Builder',null,'#jsonView','d'],
['jwt-generator','JWT Generator',null,'#genTokenDisplay','d'],
['keyboard-tester','Keyboard Tester',null,null,'u'],
['loan-calculator','Loan Calculator',null,null,'u'],
['meta-tag-generator','Meta Tag Generator','#metaTitle','#codeOutput','d'],
['neumorphism-generator','Neumorphism Generator',null,'#codeOutput','d'],
['noise-generator','Noise Generator',null,null,'u'],
['og-image-preview','OG Image Preview','#inTitle','#codeBlock','d'],
['open-graph-generator','Open Graph Generator','#ogTitle','#output','d'],
['page-title-tester','Page Title Tester','#inTitle',null,'d'],
['percentage-calculator','Percentage Calculator',null,null,'u'],
['pixel-ruler','Pixel Ruler',null,null,'u'],
['placeholder-image','Placeholder Image',null,null,'d'],
['pomodoro-timer','Pomodoro Timer',null,null,'u'],
['qr-generator','QR Code Generator',null,null,'u'],
['responsive-tester','Responsive Tester','#urlInput',null,'d'],
['screen-resolution','Screen Resolution',null,null,'u'],
['stopwatch','Stopwatch',null,null,'u'],
['subnet-calculator','Subnet Calculator','#ip','#subnet-results','d'],
['svg-path-editor','SVG Path Editor','#pathInput','#exportCode','d'],
['svg-to-css','SVG to CSS','#svgInput','#outputBase64','c'],
['text-to-binary','Text to Binary','#mainInput','#binOut','c'],
['twitter-card-preview','Twitter Card Preview','#inTitle','#metaOutput','d'],
['typescript-playground','TypeScript Playground','#codeInput',null,'d'],
['typography-scale','Typography Scale',null,'#codeBlock','d'],
['vcard-generator','vCard Generator','#vcFirst','#vcardPreview','u'],
['whiteboard','Whiteboard',null,null,'u'],
];
