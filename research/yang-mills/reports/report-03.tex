...
\item \textbf{Blocking choice.} The step map depends on the blocking (here $c=\McrgC$). The number of steps to reach a fixed region depends on it only mildly, but this was not varied here.
